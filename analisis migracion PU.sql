------CC
SELECT COUNT(*) FROM CRENTA.dbo.TRAMITE t WHERE t.ClaseRenta = 'U'
SELECT * FROM CRENTA.dbo.TRAMITE t
SELECT * FROM CRENTA.dbo.CLASEDERENTA c WHERE c.ClaseRenta = 'U'
...
SELECT * FROM CC.dbo.DOC_COMP_DH dcd LEFT JOIN CRENTA.dbo.PERSONA p--26
...
--858 ENTRE pre_beneficiarios y documento_comparativo_dh
...
SELECT * FROM PAGOS_P.dbo.Titular_PU tp
